...
abstract class AppLocalizations {
  ...
  /// No description provided for @tradeNotifications.
  ///
  /// In en, this message translates to:
  /// **'Trade Notifications'**
  String get tradeNotifications;
  ...
  /// Tooltip for the light mode button
  ///
  /// In en, this message translates to:
  /// **'Switch to Light Mode'**
  String get lightMode;

  /// Tooltip for the dark mode button
  ///
  /// In en, this message translates to:
  /// **'Switch to Dark Mode'**
  String get darkMode;

  /// Tooltip for the language change button
  ///
  /// In en, this message translates to:
  /// **'Change Language'**
  String get changeLanguage;

  /// No description provided for @validateApiKeys.
  ///
  /// In en, this message translates to:
  /// **'Validate API Keys'**
  String get validateApiKeys;
}
